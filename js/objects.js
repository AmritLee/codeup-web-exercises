(function() {
    ...
    const authorFullName = books.author.firstName + " " + books.author.lastName;
    ...
    let bookList = [
        ...
        createBook("The Scarlet Letter", "Nathaniel Hawthorne"),
        createBook("Frankenstein", "Mary Shelley"),
        createBook("The Count of Monte Cristo", "Alexander Dumas"),
    ]
